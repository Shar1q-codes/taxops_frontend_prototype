...
export default function SignupPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-semibold text-slate-900">Create firm account</h1>
      <p className="mt-1 text-sm text-slate-600">Set up your firm. All data is isolated by firm_id and client/engagement scope.</p>

      <form onSubmit={handleSubmit} className="mt-6 space-y-4">
        <div className="space-y-2">
          <label className="text-sm font-medium text-slate-800">Firm name</label>
          <input
            type="text"
            value={firmName}
